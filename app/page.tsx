            ...
            <Container size="body">
                ...
                <CardCluster>
                    <Card className="row-span-2" color={sectionColors[1].hoverColor}>
                        <Card.MainText>
                            Search and track anime using <span className="text-green-500 font-bold">Kurabu</span>.
                        </Card.MainText>
                        <div className="flex-1 z-20 mb-8">
                            <div className="m-16 p-4 bg-zinc-900 rounded-2xl border border-zinc-800">
                                <Image src={kurabuScreenshot} alt="Search page of the app, kurabu, with 'slime' in the search bar." className="rounded-2xl" />
                            </div>
                        </div>
                        <Card.ContinueButton>
                            Learn more about Kurabu
                        </Card.ContinueButton>
                    </Card>
                    <Card className="" color={sectionColors[1].hoverColor}>
                        <Card.MainText>
                            <span className="text-red-500 font-bold">4+</span> years of professional experience
                        </Card.MainText>
                        <div className="w-1/2 mx-auto mt-8 mb-8 flex-1 z-20">
                            <ol className="list-decimal font-bold text-xl">
